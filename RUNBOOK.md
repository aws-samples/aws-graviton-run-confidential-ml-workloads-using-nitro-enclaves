...
- [ ] Provide *Stack name*: "<Project-Name>-FileSharing-<ThirdParty-Name>". Add the parameters required.
...
- [ ] Create a Linux EC2 instance with Nitro Enclaves support enabled (In the step
 where you *Configure Instance Details* under *Advanced Details", check the box
 for *Enclave* to enable it)
...
- [ ] Run these commands to install the nitro-cli tool:
...
- [ ] Use the client application to start the
