...
```shell
aws kms decrypt --ciphertext-blob fileb://data_key.encrypted --region eu-west-1
...
You can then run the command `aws kms decrypt --ciphertext-blob fileb://data_key.encrypted --region eu-west-1`
